...
const Projects = () => {
  const projects = [
    ...
    },
    {
      id: 6,
      title: "Class Nexus",
      description: "A collaborative note-taking and class management platform built with the MERN stack. Enables students to organize notes, share resources, and collaborate seamlessly in real-time.",
      tech: [
        { name: "React", desc: "Frontend UI library" },
        { name: "Node.js", desc: "Backend runtime" },
      ...
      image: "/classnexus.png",
      link: "https://kai-notes.vercel.app/",
      github: "https://github.com/kavinvikraman/Hushh-kai-notes-hackathon",
      youtube: "https://youtu.be/IUKx2Bm4_k4?si=6VMoqwc6nv2ORWu9",
                  ...
                  <div className="flex gap-3 flex-wrap">
                    {project.link !== "#" && (
                      <motion.a
                        ...
                        whileTap={{ scale: 0.95 }}
                        className={`flex-1 min-w-[120px] py-2.5 bg-gradient-to-r ${project.color} rounded-xl text-white font-semibold text-sm text-center shadow-lg hover:shadow-xl transition-shadow`}
                      >
                        View Project
                      </motion.a>
                    )}
                    {project.youtube && (
                      <motion.a
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="px-4 py-2.5 bg-red-600 rounded-xl text-white font-semibold text-sm flex items-center gap-2 hover:bg-red-700 transition-colors"
                      >
